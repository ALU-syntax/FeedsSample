package com.example.feedssample.helper;
...
import com.example.feedssample.R;
...
/**
 * Created by Ardian on 16/07/2021.
 *
 */
            ...
            case REQUEST_PERMISSION: {
                ...
                if (grantResults.length > 0) {
                    for (int i = 0; i < permissions.length; i++)
                        perms.put(String.valueOf(permissions), grantResults.length);
